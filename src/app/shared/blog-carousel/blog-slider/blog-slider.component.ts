...
import { BlogSliderItemDirective } from './blog-slider-item.directive';
...
export class BlogSliderComponent implements AfterContentInit {

  @ContentChildren(BlogSliderItemDirective, { read: ElementRef }) items
